...
発売当初に購入して、コードレビューの章に感銘を受けてこの1年近く、これらを意識してコードレビューを行なってきました。
...
リーダビリティを今も実現できる自己評価にはありません。とはいえ、本書のコードレビューの指針は自分にとって良い方針だと感じています。リーダビリティについては継続して学びつつ、本書のコードレビューの指針を取り込んで、引き続きコードレビューを実践していこうと思っています。
